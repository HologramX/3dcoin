...
{
    // return tr("Total: %1 (PrimeNodes: %2 / MasterNodes: %3) (IPv4: %4, IPv6: %5, TOR: %6)").arg(QString::number((int)mnodeman.size()))
    return tr("Total: %1 (PrimeNodes: %2 / MasterNodes: %3)")
            .arg(QString::number((int)mnodeman.CountEnabled(PROTOCOL_VERSION+1) + (int)mnodeman.CountEnabled()))
            .arg(QString::number((int)mnodeman.CountEnabled(PROTOCOL_VERSION+1)))
